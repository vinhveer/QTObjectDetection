...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.frameCameraBindingBox.setMinimumSize(QSize(0, 0))
        font2 = QFont()
        ...
        self.frameCameraWarmUp.setMinimumSize(QSize(0, 0))
        ...
        sizePolicy3.setHeightForWidth(self.framePictureBindingBox.sizePolicy().hasHeightForWidth())
        self.framePictureBindingBox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.framePictureWarmUp.sizePolicy().hasHeightForWidth())
        self.framePictureWarmUp.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.listImage.sizePolicy().hasHeightForWidth())
        self.listImage.setSizePolicy(sizePolicy5)
        ...
        sizePolicy3.setHeightForWidth(self.tabWidgetResultFolder.sizePolicy().hasHeightForWidth())
        self.tabWidgetResultFolder.setSizePolicy(sizePolicy3)
        ...
        self.frameFolderBindingBox.setMinimumSize(QSize(0, 0))
        ...
        sizePolicy3.setHeightForWidth(self.frameFolderWarmUp.sizePolicy().hasHeightForWidth())
        self.frameFolderWarmUp.setSizePolicy(sizePolicy3)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.buttonSaveImageChoose.setText(QCoreApplication.translate("mainWindow", u"L\u01b0u d\u1eef li\u1ec7u nh\u1eadn di\u1ec7n (\u1ea2nh hi\u1ec7n t\u1ea1i)", None))
        self.buttonSaveAllData.setText(QCoreApplication.translate("mainWindow", u"L\u01b0u d\u1eef li\u1ec7u nh\u1eadn di\u1ec7n (To\u00e0n b\u1ed9 h\u00ecnh \u1ea3nh)", None))
